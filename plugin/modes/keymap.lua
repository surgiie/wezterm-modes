...
---
--- @param ctx table  Plugin context (noop, should_run, kt_timeout,
...
return function(ctx)
	...
	local function run(binding)
		return wezterm.action_callback(function(window, pane)
			...
			-- execute_command queues the key-table pop and the typing together,
			-- ordered after the keystroke that triggered this callback — see its
			-- doc comment for why send_text raced here.
			execute_command(window, pane, binding)
		end)
	end
